...
export default function ContactUs() {
  ...
  return (
    ...
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <h2 class="text-3xl font-semibold leading-[44px]lg:text-4xl">We’d love to hear from you</h2>

        <section class="py-10 bg-white sm:py-16 lg:py-20">
    <div class="px-1 mx-auto lg:px-1 max-w-7xl">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-12 lg:gap-x-8 xl:gap-x-20">
